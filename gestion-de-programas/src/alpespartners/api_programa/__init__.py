...
#importar blueprint
from alpespartners.api_programa import programa
...
def create_app(configuracion={}):
    ...
    logger = logging.getLogger("alpespartners.api_programa")
    logger.info("Iniciando la aplicación Flask de Programas...")
    ...
    logger.info("Aplicación Flask programa inicializada correctamente.")
    return app
