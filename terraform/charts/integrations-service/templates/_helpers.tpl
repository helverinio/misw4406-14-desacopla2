...
app.kubernetes.io/name: {{ include "integrations-service.name" . }}
...
*/}}
{{- define "integrations-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "integrations-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
