...
# Build and push Docker image for compliance-service
# Usage: ./scripts/build-and-push-compliance.sh [tag]
...
echo "🎯 You can now deploy with: ./scripts/deploy-compliance.sh"
