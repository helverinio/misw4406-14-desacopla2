...
# Deploy compliance-service using Helm
...
echo "✅ Successfully deployed compliance-service!"
echo ""
echo "📊 Deployment status:"
kubectl get pods -n ${NAMESPACE} -l app.kubernetes.io/name=compliance-service
echo ""
echo "🌐 Ingress status:"
